...
--
-- Generated by wigen at Fri Jun 16 13:00:53 2017
--
-- Configuration:
--     Number of masters:     1
--     Number of slaves:      3
--     Master address width:  32
--     Slave address width:   30
--     Port size:             32
--     Port granularity:      8
--     Entity name:           wb_db_connect
--     Pipelined arbiter:     no
--     Registered feedback:   yes
--     Unsafe slave decoder:  no
--
-- Command line:
--     wigen -e wb_db_connect -r 1 3 32 30 32 8
---------------------------------------------------------------------

library ieee;
use ieee.std_logic_1164.all;

entity wb_db_connect is
	port(
		clk_i: in std_logic;
		rst_i: in std_logic;
		...
		m0_adr_o: out std_logic_vector(29 downto 2);
		...
		m1_adr_o: out std_logic_vector(29 downto 2);
...
select_slave<="0001" when adr_mux(31 downto 30)="00" else
	"0010" when adr_mux(31 downto 30)="01" else
	"0100" when adr_mux(31 downto 30)="10" else
	"1000"; -- fallback slave
